            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-link">
                            <NavLink className="nav-link " id="new-conference" aria-current="page" to="/conferences/new">New
                                conference</NavLink>
                        </li>
                        <li className="nav-link">
                            <NavLink className="nav-link " id="new-presentation" aria-current="page" to="/presentations/new">New
                                presentation</NavLink>
                        </li>
                        <li className="nav-link">
                            <NavLink className="nav-link " id="attendees-list" aria-current="page" to="/attendees">List Attendees</NavLink>
                        </li>
                    </ul>
